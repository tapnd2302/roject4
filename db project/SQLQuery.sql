...
ALTER TABLE [dbo].[HOTEL_RESTAURANT]  WITH CHECK ADD  CONSTRAINT [FK_HOTEL_RESTAURANT_AREAS] FOREIGN KEY([AreaID])
REFERENCES [dbo].[AREAS] ([AreaID])
GO

ALTER TABLE [dbo].[HOTEL_RESTAURANT] CHECK CONSTRAINT [FK_HOTEL_RESTAURANT_AREAS]
GO

ALTER TABLE [dbo].[IMAGES]  WITH CHECK ADD  CONSTRAINT [FK_IMAGES_FOODS] FOREIGN KEY([ID])
REFERENCES [dbo].[FOODS] ([FoodID])
GO

ALTER TABLE [dbo].[IMAGES] CHECK CONSTRAINT [FK_IMAGES_FOODS]
GO

ALTER TABLE [dbo].[IMAGES]  WITH CHECK ADD  CONSTRAINT [FK_IMAGES_HOTEL_RESTAURANT] FOREIGN KEY([ID])
REFERENCES [dbo].[HOTEL_RESTAURANT] ([HRID])
GO

ALTER TABLE [dbo].[IMAGES] CHECK CONSTRAINT [FK_IMAGES_HOTEL_RESTAURANT]
GO

ALTER TABLE [dbo].[IMAGES]  WITH CHECK ADD  CONSTRAINT [FK_IMAGES_ROOMS] FOREIGN KEY([ID])
...
ALTER TABLE [dbo].[IMAGES]  WITH CHECK ADD  CONSTRAINT [FK_IMAGES_USERS] FOREIGN KEY([ID])
REFERENCES [dbo].[USERS] ([AccountID])
GO
